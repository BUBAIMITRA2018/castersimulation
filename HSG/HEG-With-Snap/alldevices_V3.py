...
class AllDevices:
    ...
    def __init__(self,comobject,import_file_path):
        ...
        self.dfdamper = pd.read_excel(import_file_path, sheet_name='Damper')
        ...
        self.alldamperobjects = callalldamper.Cal_AllDamper(self.dfdamper, comobject,import_file_path)
