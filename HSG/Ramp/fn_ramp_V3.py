...
class Fn_Ramp(Eventmanager):
    ...
    def initialization(self):
        ...
        self.Maxoffsetrawvalue = self.unscaling(self.Maxoffset, 27648, self.highlimit, self.lowerlimit, 0)
        self.Minoffsetrawvalue = self.unscaling(self.Minoffset, 27648, self.highlimit, self.lowerlimit, 0)
