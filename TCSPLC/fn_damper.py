    ...
    def initilizedigitalinput(self):
        try:
            ...
            if len(self.faultfb)>3:
                writegeneral.writesymbolvalue(self.faultfb, 1, 'S7WLBit')
                level = logging.INFO
                messege = self.devicename + ":" + self.faultfb + " is trigger by 1"
                logger.log(level, messege)
        ...
        try:
            ...
            if self.opncmdvalue == True and self.clscmdvalue == False:
                ...
                if len(self.postion)>3:
                    writegeneral.writesymbolvalue(self.postion, 25, 'S7WLWord')
                    sleep(1)
                    writegeneral.writesymbolvalue(self.postion, 50, 'S7WLWord')
                    sleep(1)
                    writegeneral.writesymbolvalue(self.postion, 75, 'S7WLWord')
                    sleep(1)
                    writegeneral.writesymbolvalue(self.postion, 100, 'S7WLWord')
                else:
                    sleep(5)
