...
class Fn_RailSwitch6(Eventmanager):
    ...
    def setup(self):
        try:
            ...
            self.drivecmdtag = str("db27.dbw540")
            self.trackposition = str(270.3)
            self.forwardendpoint = str(270.4)
            self.reverseendpoint = str(270.5)
            self.trackposition1 = str(271.0)
            self.forwardendpoint1 = str(271.1)
            self.reverseendpoint1 = str(271.2)
            self.trackposition2 = str(271.5)
            self.forwardendpoint2 = str(271.6)
            self.reverseendpoint2 = str(271.7)
            self.trackposition3 = str(272.2)
            self.forwardendpoint3 = str(272.3)
            self.reverseendpoint3 = str(272.4)
            self.counter = str("db65.dbw28")
