...
class Fn_RailSwitch8(Eventmanager):
    ...
    def setup(self):
        try:
                    ...
                    self.drivecmdtag = str("db27.dbw580")
                    self.trackposition = str(275.3)
                    self.forwardendpoint = str(275.4)
                    self.reverseendpoint = str(275.5)
                    self.trackposition1 = str(276.0)
                    self.forwardendpoint1 = str(276.1)
                    self.reverseendpoint1 = str(276.2)
                    self.counter = str("db65.dbw32")
