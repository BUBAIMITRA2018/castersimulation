...
class Fn_RailSwitch5(Eventmanager):
    ...
    def setup(self):
        try:
            ...
            self.drivecmdtag = str("db27.dbw520")
            self.trackposition = str(267.7)
            self.forwardendpoint = str(268.0)
            self.reverseendpoint = str(268.1)
            self.trackposition1 = str(268.4)
            self.forwardendpoint1 = str(268.5)
            self.reverseendpoint1 = str(268.6)
            self.trackposition2 = str(269.1)
            self.forwardendpoint2 = str(269.2)
            self.reverseendpoint2 = str(269.3)
            self.trackposition3 = str(269.6)
            self.forwardendpoint3 = str(269.7)
            self.reverseendpoint3 = str(270.0)
            self.counter = str("db65.dbw26")
