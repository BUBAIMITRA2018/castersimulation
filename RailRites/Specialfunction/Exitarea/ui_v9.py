...
import railswitch9processing
import railswitch10processing
import railswitch11processing
import railswitch12processing
import general
import time
...
class FormUi:
    ...
    def initilization(self):
        ...
        try:
            ...
            self.railswitch9object = railswitch9processing.railswitchProcess9(self.alldevices)
            self.railswitch10object = railswitch10processing.railswitchProcess10(self.alldevices)
            self.railswitch11object = railswitch11processing.railswitchProcess11(self.alldevices)
            self.railswitch12object = railswitch12processing.railswitchProcess12(self.alldevices)
    ...
    def callrailswitchs9(self):
        while not self.DEAD:
            self.railswitch9object.process()
            time.sleep(2)

    def callrailswitchs10(self):
        while not self.DEAD:
            self.railswitch10object.process()
            time.sleep(2)

    def callrailswitchs11(self):
        while not self.DEAD:
            self.railswitch11object.process()
            time.sleep(2)

    def callrailswitchs12(self):
        while not self.DEAD:
            self.railswitch12object.process()
            time.sleep(2)
    ...
    def railswitch8start(self):
        ...
        self.railswitch8startbutton.configure(text="railswitch8started")

    def railswitch9start(self):
        self.DEAD = False
        self.railswitch9tread = threading.Thread(target=self.callrailswitchs9)
        self.railswitch9tread.start()
        self.railswitch9startbutton.configure(text="railswitch9started")

    def railswitch10start(self):
        self.DEAD = False
        self.railswitch10tread = threading.Thread(target=self.callrailswitchs10)
        self.railswitch10tread.start()
        self.railswitch10startbutton.configure(text="railswitch10started")

    def railswitch11start(self):
        self.DEAD = False
        self.railswitch11tread = threading.Thread(target=self.callrailswitchs11)
        self.railswitch11tread.start()
        self.railswitch11startbutton.configure(text="railswitch11started")

    def railswitch12start(self):
        self.DEAD = False
        self.railswitch12tread = threading.Thread(target=self.callrailswitchs12)
        self.railswitch12tread.start()
        self.railswitch12startbutton.configure(text="railswitch12started")
    ...
    def startprocess(self):
        ...
        self.railswitch4startbutton.grid(column=0, row=4)
        self.railswitch5startbutton = ttk.Button(self.win, text='railswitch5start', command=self.railswitch5start)
        self.railswitch5startbutton.grid(column=0, row=5)
        self.railswitch6startbutton = ttk.Button(self.win, text='railswitch6start', command=self.railswitch6start)
        self.railswitch6startbutton.grid(column=1, row=0)
        self.railswitch7startbutton = ttk.Button(self.win, text='railswitch7start', command=self.railswitch7start)
        self.railswitch7startbutton.grid(column=1, row=1)
        self.railswitch8startbutton = ttk.Button(self.win, text='railswitch8start', command=self.railswitch8start)
        self.railswitch8startbutton.grid(column=1, row=2)
        self.railswitch9startbutton = ttk.Button(self.win, text='railswitch9start', command=self.railswitch9start)
        self.railswitch9startbutton.grid(column=1, row=3)
        self.railswitch10startbutton = ttk.Button(self.win, text='railswitch105start', command=self.railswitch10start)
        self.railswitch10startbutton.grid(column=1, row=4)
        self.railswitch11startbutton = ttk.Button(self.win, text='railswitch11start', command=self.railswitch11start)
        self.railswitch11startbutton.grid(column=1, row=5)
        self.railswitch12startbutton = ttk.Button(self.win, text='railswitch12start', command=self.railswitch12start)
        self.railswitch12startbutton.grid(column=1, row=6)
    ...
    def stopprocess(self):
        ...
        self.railswitch8startbutton.configure(text='railswitch8start')
        self.railswitch9startbutton.configure(text='railswitch9start')
        self.railswitch10startbutton.configure(text='railswitch10start')
        self.railswitch11startbutton.configure(text='railswitch11start')
        self.railswitch12startbutton.configure(text='railswitch12start')
