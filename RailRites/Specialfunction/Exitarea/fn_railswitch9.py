...
__all__ = ['Fn_RailSwitch9']


class Fn_RailSwitch9(Eventmanager):
    ...
    def setup(self):
        try:
            ...
            self.drivecmdtag = str("db27.dbw620")
            self.trackposition = str(294.0)
            self.forwardendpoint = str(294.1)
            self.reverseendpoint = str(294.2)
            self.trackposition1 = str(294.5)
            self.forwardendpoint1 = str(294.6)
            self.reverseendpoint1 = str(294.7)
            self.trackposition2 = str(295.2)
            self.forwardendpoint2 = str(295.3)
            self.reverseendpoint2 = str(295.4)
            self.trackposition3 = str(295.7)
            self.forwardendpoint3 = str(296.0)
            self.reverseendpoint3 = str(296.1)
            self.counter = str("db65.dbw34")
    ...
    def process(self):
        ...
        try:
            ...
            log_exception(e)
            level = logging.INFO
            messege = "FN_RailSwitch2" + ":" + " Exception rasied(process): " + str(e.args) + str(e)
            logger.log(level, messege)
