...
__all__ = ['Fn_RailSwitch10']


class Fn_RailSwitch10(Eventmanager):
    ...
    def setup(self):
        try:
            ...
            self.drivecmdtag = str("db27.dbw640")
            self.trackposition = str(296.4)
            self.forwardendpoint = str(296.5)
            self.reverseendpoint = str(296.6)
            self.trackposition1 = str(297.1)
            self.forwardendpoint1 = str(297.2)
            self.reverseendpoint1 = str(297.3)
            self.trackposition2 = str(297.6)
            self.forwardendpoint2 = str(297.7)
            self.reverseendpoint2 = str(298.0)
            self.trackposition3 = str(298.3)
            self.forwardendpoint3 = str(298.4)
            self.reverseendpoint3 = str(298.5)
            self.counter = str("db65.dbw36")
    ...
    def process(self):
        ...
        try:
            ...
            log_exception(e)
            level = logging.INFO
            messege = "FN_RailSwitch3" + ":" + " Exception rasied(process): " + str(e.args) + str(e)
            logger.log(level, messege)
