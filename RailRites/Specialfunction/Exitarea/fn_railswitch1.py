...
class Fn_RailSwitch1(Eventmanager):
    ...
    def setup(self):
        try:
            ...
            self.drivecmdtag = str("db27.dbw420")
            self.trackposition = str(232.3)
            self.forwardendpoint = str(232.4)
            self.reverseendpoint = str(232.5)
            self.trackposition1 = str(233.0)
            self.forwardendpoint1 = str(233.1)
