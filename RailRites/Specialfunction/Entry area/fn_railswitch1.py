...
class Fn_RailSwitch1(Eventmanager):
    ...
    def setup(self):
        try:
            ...
            self.drivecmdtag = str("db27.dbw40")
            self.trackposition = str(18.7)
            self.forwardendpoint = str(19.0)
            self.reverseendpoint = str(19.1)
            self.trackposition1 = str(19.4)
            self.forwardendpoint1 = str(20.2)
            self.reverseendpoint1 = str(19.6)
            self.trackposition2 = str(20.1)
            self.forwardendpoint2 = str(19.5)
            self.reverseendpoint2 = str(20.3)
            self.trackposition3 = str(20.6)
            self.forwardendpoint3 = str(20.7)
            self.reverseendpoint3 = str(21.0)
            self.rdolcmd = str(19.7)
            ...
            self.pos6 = str(15.6)
            self.pos7 = str(16.0)
            self.counter = str("db65.dbw2")
            self.rdollowcmd = str(19.3)
            self.rollertable1 = str(16.2)
