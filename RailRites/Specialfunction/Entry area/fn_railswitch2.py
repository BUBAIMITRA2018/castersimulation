...
class Fn_RailSwitch2(Eventmanager):
    ...
    def setup(self):
        try:
            ...
            self.drivecmdtag = str("db27.dbw80")
            self.trackposition = str(35.0)
            self.forwardendpoint = str(35.1)
            self.reverseendpoint = str(35.2)
            self.trackposition1 = str(35.5)
            self.forwardendpoint1 = str(35.6)
            self.reverseendpoint1 = str(35.7)
            self.trackposition2 = str(36.2)
            self.forwardendpoint2 = str(36.3)
            self.reverseendpoint2 = str(36.4)
            self.trackposition3 = str(36.7)
            self.forwardendpoint3 = str(37.0)
            self.reverseendpoint3 = str(37.1)
            self.rdolcmd = str(35.3)
            ...
            self.pos6 = str(34.2)
            self.pos7 = str(34.4)
            self.counter = str("db65.dbw4")
            self.rdollowcmd = str(35.4)
            self.rollertable1 = str(34.6)
