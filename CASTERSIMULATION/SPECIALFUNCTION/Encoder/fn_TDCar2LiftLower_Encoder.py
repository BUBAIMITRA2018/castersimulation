...
__all__ = ['Fn_TDCar2LiftLower_Encoder']
...
class Fn_TDCar2LiftLower_Encoder():

    def __init__(self,filename):

        self.devicename = 'TDCar2LiftLower'
    ...
    def setup(self):
        try:
            ...
            self.areatag = str(621.2)
            self.speedFB = str('db1431.dbd176')
            self.encoderoutputtag = str(3242)
            ...
            level = logging.ERROR
            messege = "TDCar2LiftLower" + self.devicename + " Error messege(setup)" + str(e.args)
