...
__all__ = ['Fn_Arm2Lift_Encoder_Encoder']
...
class Fn_Arm2Lift_Encoder_Encoder():

    def __init__(self, filename):

        self.devicename = 'Arm2Lift_Encoder'
    ...
    def setup(self):
        try:
            ...
            self.speedFB = str('db3634.dbd32')
            self.encoderoutputtag = str(3230)
            ...
            level = logging.ERROR
            messege = " Fn_Arm2Lift" + self.devicename + " Error messege(setup)" + str(e.args)
