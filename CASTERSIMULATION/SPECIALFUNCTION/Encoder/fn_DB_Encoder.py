...
__all__ = ['Fn_DB_Encoder_Encoder']




class Fn_DB_Encoder_Encoder():

    def __init__(self,filename):

        self.devicename = 'DB_Encoder'
    ...
    def setup(self):
        try:
            ...
            self.speedFB = str('db1611.dbd176')
            self.encoderoutputtag = str(3604)
            ...
            level = logging.ERROR
            messege = "DB Encoder" + self.devicename + " Error messege(setup)" + str(e.args)
