...
__all__ = ['Fn_LevellingRollPos_Encoder']
...
class Fn_LevellingRollPos_Encoder():

    def __init__(self,filename):

        self.devicename = 'Levelling Roll Pos'
    ...
    def setup(self):
        try:
            ...
            self.speedFB = str('db2903.dbd12')
            self.encoderoutputtag = str(3202)
            self.mtrnominalSpd = int(1185)
            ...
            level = logging.ERROR
            messege = "Fn_Levelling Roll Pos" + self.devicename + " Error messege(setup)" + str(e.args)
