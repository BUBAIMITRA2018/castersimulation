...
class Fn_PR_Encoder_Encoder():

    def __init__(self, filename):

        self.devicename = 'PR_Encoder'
    ...
    def setup(self):
        try:
            ...
            self.speedFB = str('db1571.dbd176')
            self.encoderoutputtag = str(3606)
            ...
            level = logging.ERROR
            messege = "PR_Encoder" + self.devicename + " Error messege(setup)" + str(e.args)
