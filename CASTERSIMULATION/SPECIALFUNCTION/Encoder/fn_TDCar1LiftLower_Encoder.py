...
__all__ = ['Fn_TDCar1LiftLower_Encoder']
...
class Fn_TDCar1LiftLower_Encoder():

    def __init__(self,filename):
        self.devicename = 'TDCar1LiftLower'
    ...
    def setup(self):
        try:
            ...
            self.areatag = str(621.0)
            self.speedFB = str('db1411.dbd176')
            self.encoderoutputtag = str(3238)
            ...
            level = logging.ERROR
            messege = "TDCar1LiftLower" + self.devicename + " Error messege(setup)" + str(e.args)
