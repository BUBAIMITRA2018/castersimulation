...
class FormUi:
    ...
    def initilization(self):
        ...
        try:
            ...
            self.railswitchobject = allrailswitchprocessing.railswitchprocess(self.alldevices, self.import_file_path)
    ...
    def callrailswitchs(self,com,devices):
        while not self.DEAD:
    ...
    def railswitchstart(self):
        self.DEAD = False
        self.railswitchtread = threading.Thread(target=self.callrailswitchs,args=(self.comm_object, self.alldevices))
    ...
    def startprocess(self):
        ...
        self.digitalstartbutton.grid(column=1, row=4)

        self.railswitchstartbutton = ttk.Button(self.win, text='railswitchvalstart', command=self.digitalstart)
        self.railswitchstartbutton.grid(column=1, row=5)
    ...
    def stopprocess(self):
        ...
        self.railswitchstartbutton.configure(text='railswitchvalstart')
